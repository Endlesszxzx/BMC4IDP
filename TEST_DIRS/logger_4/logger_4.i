...
void task_measure(void)
{
  ...
  if (tickCounter == period) {
    ...
    numberOfRecords++;
    ((void) sizeof ((numberOfRecords==pos+1) ? 1 : 0), __extension__ ({ if (numberOfRecords==pos+1) ; else __assert_fail ("numberOfRecords==pos+1", "po_logger2_bug.c", 80, __extension__ __PRETTY_FUNCTION__); }));
  }
}
