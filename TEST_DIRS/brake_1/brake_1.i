...
void task_compute(void) {
        ...
        if (test != 0) {
            ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "brake_1.c", 321, __extension__ __PRETTY_FUNCTION__); }));
        }
        if (test != 1) {
        }
        if (test != 2) {
        ...
        if (test <= 0) {
            ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "brake_1.c", 337, __extension__ __PRETTY_FUNCTION__); }));
        }
        test++;
