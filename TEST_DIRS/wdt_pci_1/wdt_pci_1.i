...
void closer1(void ) {
    while(cnt1 < 5) {
        ...
        if (expect_close != 42) {
            ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "wdt_pci_1.c", 973, __extension__ __PRETTY_FUNCTION__); }));
        } else {
        }
        expect_close = 0;
        cnt1++;
...
void closer2(void ) {
    while(cnt2 < 5) {
        ...
        if (expect_close != 42) {
            ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "wdt_pci_1.c", 1006, __extension__ __PRETTY_FUNCTION__); }));
        } else {
        }
        expect_close = 0;
        cnt2++;
