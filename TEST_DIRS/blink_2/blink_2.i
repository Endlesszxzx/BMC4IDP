...
unsigned char _ME2;
unsigned char _P1IN;
unsigned char _P1OUT;
unsigned char _P1DIR;
unsigned char _P1IFG;
unsigned char _P1IES;
unsigned char _P1IE;
unsigned char _P1SEL;
unsigned char _P2IN;
unsigned char _P2OUT;
unsigned char _P2DIR;
unsigned char _P2IFG;
unsigned char _P2IES;
unsigned char _P2IE;
unsigned char _P2SEL;
unsigned char _P3IN;
unsigned char _P3OUT;
unsigned char _P3DIR;
unsigned char _P3SEL;
unsigned char _P4IN;
unsigned char _P4OUT;
unsigned char _P4DIR;
unsigned char _P4SEL;
unsigned char _P5IN;
unsigned char _P5OUT;
unsigned char _P5DIR;
unsigned char _P5SEL;
unsigned char _P6IN;
unsigned char _P6OUT;
unsigned char _P6DIR;
unsigned char _P6SEL;
unsigned char _SVSCTL;
unsigned char _BCSCTL2;
unsigned char _BCSCTL1;
unsigned char _DCOCTL;
unsigned char _CAPD;
unsigned char _CACTL2;
unsigned char _CACTL1;
unsigned char _U0TXBUF;
unsigned char _U0RXBUF;
unsigned char _U0BR1;
unsigned char _U0BR0;
unsigned char _U0MCTL;
unsigned char _U0RCTL;
unsigned char _U0TCTL;
unsigned char _U0CTL;
unsigned short _U1TXBUF;
unsigned short _U1RXBUF;
unsigned short _U1BR1;
unsigned short _U1BR0;
unsigned short _U1MCTL;
unsigned short _U1RCTL;
unsigned short _U1TCTL;
unsigned short _U1CTL;
unsigned short _WDTCTL;
unsigned short _FCTL3;
unsigned short _FCTL2;
unsigned short _FCTL1;
unsigned short _SUMEXT;
unsigned short _RESHI;
unsigned short _RESLO;
unsigned short _OP2;
unsigned short _MACS;
unsigned short _MAC;
unsigned short _MPYS;
unsigned short _MPY;
unsigned short _TACCTL2;
unsigned short _TACCTL1;
unsigned short _TACCTL0;
unsigned short _TACTL;
unsigned short _TAIV;
unsigned short _TACCR2;
unsigned short _TACCR1;
unsigned short _TACCR0;
unsigned short _TAR;
void set_TACTL_bit2()
{
  _TAR = 0x0000;
...
unsigned short _TBCCR6;
unsigned short _TBCCR5;
unsigned short _TBCCR4;
unsigned short _TBCCR3;
unsigned short _TBCCR2;
unsigned short _TBCCR1;
unsigned short _TBCCR0;
unsigned short _TBR;
unsigned short _TBCCTL6;
unsigned short _TBCCTL5;
unsigned short _TBCCTL4;
unsigned short _TBCCTL3;
unsigned short _TBCCTL2;
unsigned short _TBCCTL1;
unsigned short _TBCCTL0;
unsigned short _TBCTL;
unsigned short _TBIV;
void set_TBCTL_bit2()
{
  _TBR = 0x0000;
  _TBCTL &= 0xFF0B;
}
unsigned short _ADC12IV;
unsigned short _ADC12IE;
unsigned short _ADC12IFG;
unsigned short _ADC12CTL1;
unsigned short _ADC12CTL0;
unsigned short _ADC12MEM[16];
unsigned char _ADC12MCTL[16];
unsigned short _DAC12_1DAT;
unsigned short _DAC12_1CTL;
unsigned short _DAC12_0DAT;
unsigned short _DAC12_0CTL;
unsigned short _DMA2SZ;
unsigned short _DMA2DA;
unsigned short _DMA2SA;
unsigned short _DMA2CTL;
unsigned short _DMA1SZ;
unsigned short _DMA1DA;
unsigned short _DMA1SA;
unsigned short _DMA1CTL;
unsigned short _DMA0SZ;
unsigned short _DMA0DA;
unsigned short _DMA0SA;
unsigned short _DMA0CTL;
unsigned short _DMACTL1;
unsigned short _DMACTL0;
