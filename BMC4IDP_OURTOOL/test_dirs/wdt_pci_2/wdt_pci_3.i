...
void closer3(void) {
        ...
        if (expect_close != 42) {
            ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "wdt_pci_3.c", 1047, __extension__ __PRETTY_FUNCTION__); }));
        } else {
        }
        expect_close = 0;
        cnt5++;
...
void closer4(void) {
    ...
    closer1();
        ...
        if (expect_close != 42) {
            ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "wdt_pci_3.c", 1082, __extension__ __PRETTY_FUNCTION__); }));
        } else {
        }
        expect_close = 0;
        cnt8++;
