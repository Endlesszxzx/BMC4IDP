...
for(per_thread_mapt::const_iterator __thread1=per_thread_map.begin();__thread1!=per_thread_map.end();++__thread1) for(auto __thread2=++(per_thread_mapt::const_iterator{__thread1});__thread2!=per_thread_map.end();++__thread2)
