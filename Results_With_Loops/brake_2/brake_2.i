...
void task_compute(void)
{
    ...
    * brake_acc_nodiv_ctrl_P.vkmh_Gain;
  {
    ...
    brake_acc_nodiv_ctrl_P.average_rpm_Gain * brake_acc_nodiv_ctrl_P.wgrads_Gain
    * brake_acc_nodiv_ctrl_P.vkmh_Gain;
    ((void) sizeof ((fabs(vkmh-tmp)<=0.001) ? 1 : 0), __extension__ ({ if (fabs(vkmh-tmp)<=0.001) ; else __assert_fail ("fabs(vkmh-tmp)<=0.001", "brake_2.c", 259, __extension__ __PRETTY_FUNCTION__); }));
  }
